...
import { PROVIDER_ADAPTATIONS, ROLE_PRESETS } from "../presets";
...
export class Role extends Component<RoleProps> {
    ...
    render(props: RoleProps, _resolvedValue: undefined, context: RenderContext): PuptNode {
        const { preset, title, expertise, experience, traits, domain, delimiter = "xml", children } = props;

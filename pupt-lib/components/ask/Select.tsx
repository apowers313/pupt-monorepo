import { z } from 'zod';
import { Component, isPuptElement, isElementOfType, PROPS, CHILDREN } from 'pupt-lib';
import { askBaseSchema, attachRequirement } from './utils';
import type { PuptNode, PuptElement, RenderContext, InputRequirement } from 'pupt-lib';
